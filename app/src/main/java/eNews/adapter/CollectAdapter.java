...
*/
		if(DataBaseHelper.TEXT.equals(collectModel.getType())){
		...
		}else if(DataBaseHelper.VIDEO.equals(collectModel.getType())){		
			...
			convertView
					.setOnClickListener(new newsVideoItemOnclick(videoModel));
		}else if(DataBaseHelper.PICTURE.equals(collectModel.getType())){	
			...
			convertView.setOnClickListener(new newsPictureItemOnclick(
					pictureModel, PictureDetailActivity.class));
		}else if(DataBaseHelper.MEITU.equals(collectModel.getType())){	
