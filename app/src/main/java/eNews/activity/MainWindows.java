...
public class MainWindows extends Activity implements OnClickListener {
	...
	private MainWindowsHandler mainWindowsHandler;//这是个自定义的 Handler
	private ImageView logo;
	private DrawerLayout drawerLayout;//这是一个侧滑的布局 配合Frangment布局使用

	private LinearLayout menu_left;//左侧滑
	private LinearLayout menu_mainLayout; //主菜单
	...
	private showCollectActivity showcollectActivityListener;//判断是否登录的接口
	...
	private void init() {
		...
		mainWindowsHandler = new MainWindowsHandler(this);//这是个自定义的 Handler
		...
		menu_left = (LinearLayout) findViewById(R.id.menuLayout);//左边抽屉
